...
export default function EditorPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Drag & Drop for Links (within link-list block)
            ...
            <div className="p-4 lg:p-6 max-w-3xl mx-auto pb-20">
              {activeTab === 'edit' && (
                <EditTab
                  ...
                  onBlockDragStart={blockDragDrop.handleDragStart}
                  onBlockDragEnd={blockDragDrop.handleDragEnd}
                  onBlockDragOver={blockDragDrop.handleDragOver}
                  onBlockDrop={(e, index) => blockDragDrop.handleDrop(e, index, handleBlockReorder)}
                  onBlockTouchStart={blockDragDrop.handleTouchStart}
                  onBlockTouchMove={blockDragDrop.handleTouchMove}
