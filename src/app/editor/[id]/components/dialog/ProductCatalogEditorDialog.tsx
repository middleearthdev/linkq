...
import {
  ...
  ImageIcon, Search, Plus, CheckSquare, Grid2x2, Grid3x3
} from "lucide-react"
...
function ProductLayoutDialog({
  ...
  currentColumns: 'small' | 'medium' | 'large'
  onClose: () => void
  onSelectLayout: (columns: 'small' | 'medium' | 'large') => void
}) {
  return (
    <div className="fixed inset-0 z-[60] bg-black/50 flex items-center justify-center p-4">
      <div className="bg-background rounded-2xl shadow-2xl max-w-md w-full p-6">
        <h3 className="text-lg font-bold mb-4">Product Grid Layout</h3>
        <div className="space-y-3 mb-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="font-medium">Small (3 columns)</div>
                <div className="text-xs text-muted-foreground">Best for mobile</div>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <div className="font-medium">Medium (2 columns)</div>
          ...
          {/* Large - 1 column */}
          <button
            onClick={() => onSelectLayout('large')}
            className={`w-full p-4 rounded-lg border-2 transition-all ${
              currentColumns === 'large'
                ? 'border-primary bg-primary/5'
                : 'border-border hover:border-primary/50'
            }`}
          >
            <div className="flex items-center gap-3">
              <Grid2x2 className="h-5 w-5 rotate-90" />
              <div className="text-left">
                <div className="font-medium">Large (1 column)</div>
                <div className="text-xs text-muted-foreground">Full width display</div>
              </div>
            </div>
          </button>
        </div>
