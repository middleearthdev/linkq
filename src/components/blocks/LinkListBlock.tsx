...
export function LinkListBlock({ props, className, isEditing = false }: LinkListBlockComponentProps) {
  ...
  // LinkWrapper component with ShareMenu for all link styles (Mobile-First: Always visible)
  const LinkWrapper = ({ children, item }: { children: React.ReactNode; item: any }) => {
    return (
      <div className="relative w-full">
        {children}
        {!isEditing && (
          <div className="absolute right-2 top-1/2 -translate-y-1/2 z-10">
            <ShareMenu link={{ title: item.title, url: item.url }} textColor={customColors?.text} />
          </div>
        )}
      </div>
    )
  ...
  const renderLink = (item: any, index: number) => {
    ...
    // Helper function to render icon/image on left with centered text
    const renderIconAndText = (textClassName: string = 'font-medium text-sm sm:text-base', iconSize: string = 'w-5 h-5 sm:w-6 sm:h-6') => (
      <>
        {/* Icon/Image - positioned on the left */}
        {(item.image || item.icon) && (
          <div className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2" style={{ color: 'inherit' }}>
            {item.image ? (
              <div className={cn("rounded-md overflow-hidden flex-shrink-0", iconSize)}>
                <img
                  src={item.image}
                  alt={item.title}
        ...
        {/* Text - centered */}
        <span
          className={cn(textClassName, "w-full text-center")}
          style={undefined}
        >
          {item.title}
        </span>
    ...
    if (validatedStyle === 'pill') {
      return (
        <LinkWrapper key={item.id || index} item={item}>
          <button
            className={cn(
              baseClasses,
              'rounded-lg min-h-16 px-4 sm:px-6 font-medium relative',
              customColors
                ? 'hover:scale-105'
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          <button
            className={cn(
              baseClasses,
              'min-h-16 px-4 sm:px-6 relative group rounded-lg overflow-hidden',
              'transition-all duration-300 active:scale-[0.98]'
            )}
            style={{
              backgroundColor: customColors?.primary || '#ec4899',
              boxShadow: customColors
                ? `0 0 20px ${customColors.primary}80, 0 0 40px ${customColors.secondary || customColors.primary}60`
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = customColors
                ? `0 0 30px ${customColors.primary}CC, 0 0 60px ${customColors.secondary || customColors.primary}80, 0 0 80px ${customColors.secondary || customColors.primary}40`
                : '0 0 30px rgba(236,72,153,0.8), 0 0 60px rgba(168,85,247,0.5), 0 0 80px rgba(168,85,247,0.25)'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = customColors
                ? `0 0 20px ${customColors.primary}80, 0 0 40px ${customColors.secondary || customColors.primary}60`
          ...
          >
            ...
            <div
              className="absolute inset-0 rounded-lg border-2 group-hover:brightness-125 transition-all duration-300 z-0"
              style={{
                borderImage: customColors?.secondary
                  ? `linear-gradient(135deg, ${customColors.primary}, ${customColors.secondary}) 1`
                  : undefined,
                borderColor: !customColors?.secondary ? (customColors?.primary || '#ec4899') : undefined,
                boxShadow: customColors
                  ? `inset 0 0 15px ${customColors.secondary || customColors.primary}50`
            ...
            {customColors?.secondary && (
              <div
                className="absolute inset-0 rounded-lg opacity-30 group-hover:opacity-50 transition-opacity duration-300 z-0"
                style={{
                  background: `radial-gradient(circle at 50% 50%, ${customColors.secondary}40, transparent 70%)`
                }}
              />
            )}

            {renderIconAndText('font-bold text-sm tracking-wider relative z-10')}
          </button>
        </LinkWrapper>
      )
    }
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          <button
            className={cn(
              baseClasses,
              'min-h-16 px-4 relative group rounded-none overflow-hidden',
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          <button
            className={cn(
              baseClasses,
              'min-h-16 px-4 sm:px-6 relative group rounded-xl overflow-hidden',
              'transition-all duration-500 active:scale-[0.98]',
            )}
            style={{
              background: customColors
                ? `linear-gradient(${customColors.gradientDirection || 'to right'}, ${customColors.primary || '#8b5cf6'}, ${customColors.secondary || '#ec4899'})`
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-white/20 to-transparent
                          ...
                          transition-transform duration-1000 ease-out z-0" />

            {/* Rainbow reflection */}
            <div className="absolute inset-0 rounded-xl opacity-30 group-hover:opacity-50 transition-opacity duration-300 z-0"
              style={{
            ...
            {renderIconAndText('font-bold text-sm tracking-wider drop-shadow-lg relative z-10')}
          </button>
        </LinkWrapper>
      )
    }
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          <button
            className={cn(
              baseClasses,
              'min-h-16 px-4 sm:px-6 relative group overflow-hidden',
          ...
          >
            {/* Bubble highlights */}
            <div
              className="absolute top-2 left-4 w-3 h-3 rounded-full z-0"
              style={{ backgroundColor: `${customColors?.highlight || '#ffffff'}30` }}
            ></div>
            <div
              className="absolute top-4 right-6 w-2 h-2 rounded-full z-0"
              style={{ backgroundColor: `${customColors?.highlight || '#ffffff'}20` }}
            ></div>
            <div
              className="absolute bottom-3 left-8 w-1 h-1 rounded-full z-0"
              style={{ backgroundColor: `${customColors?.highlight || '#ffffff'}40` }}
            ></div>

            {renderIconAndText('font-semibold text-sm relative z-10')}
          </button>
        </LinkWrapper>
      )
    }
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          <button
            className={cn(
              baseClasses,
              'min-h-16 px-4 sm:px-6 relative group border-2',
              'transition-all duration-200 active:scale-[0.98]',
            )}
            style={{
              background: customColors?.secondary
                ? `linear-gradient(135deg, ${customColors.primary} 0%, ${customColors.primary} 50%, ${customColors.secondary}20 100%)`
                : (customColors?.primary || '#06b6d4'),
              borderColor: customColors?.secondary || customColors?.primary || '#06b6d4',
              clipPath: 'polygon(8px 0%, 100% 0%, calc(100% - 8px) 100%, 0% 100%)',
              boxShadow: customColors
                ? `0 0 15px ${customColors.primary}80, 0 0 25px ${customColors.secondary || customColors.primary}60`
                : '0 0 15px rgba(6,182,212,0.5), 0 0 25px rgba(168,85,247,0.4)',
              color: 'var(--custom-text-color)'
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = customColors
                ? `0 0 25px ${customColors.primary}CC, 0 0 40px ${customColors.secondary || customColors.primary}80, inset 0 0 30px ${customColors.secondary || customColors.primary}40`
                : '0 0 25px rgba(6,182,212,0.8), 0 0 40px rgba(168,85,247,0.5), inset 0 0 30px rgba(168,85,247,0.25)'
              if (customColors?.secondary) {
                e.currentTarget.style.borderColor = customColors.secondary
              }
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = customColors
                ...
                : '0 0 15px rgba(6,182,212,0.5), 0 0 25px rgba(168,85,247,0.4)'
              if (customColors?.secondary) {
                e.currentTarget.style.borderColor = customColors.secondary || customColors?.primary || '#06b6d4'
              }
            }}
            onClick={() => handleLinkClick(item)}
            disabled={isEditing}
          >
            {/* Scan lines with secondary color */}
            {customColors?.secondary && (
              <div
                className="absolute inset-0 opacity-15 z-0"
                style={{
                  backgroundImage: `repeating-linear-gradient(0deg, transparent, transparent 2px, ${customColors.secondary}50 2px, ${customColors.secondary}50 3px)`,
                }}
              />
            )}
            ...
            {customColors?.secondary && (
              <div
                className="absolute top-0 right-0 w-1/2 h-full opacity-20 group-hover:opacity-40 transition-opacity duration-300 z-0"
                style={{
                  background: `linear-gradient(to left, ${customColors.secondary}60, transparent)`
                }}
              />
            )}
            ...
            {customColors?.secondary && (
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, transparent 30%, ${customColors.secondary}80 50%, transparent 70%)`
                }}
              />
            )}

            {renderIconAndText('font-bold text-sm tracking-wider relative z-10 text-[var(--custom-text-color)]')}
          </button>
        </LinkWrapper>
      )
    }
        ...
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent
                          ...
                          transition-transform duration-700 ease-out z-0" />
            ...
            {renderIconAndText('font-semibold text-sm drop-shadow-sm relative z-10')}
          </button>
        </LinkWrapper>
      )
    }
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          <button
            className={cn(
              baseClasses,
              'min-h-16 px-4 relative group border font-mono',
              'transition-all duration-200 active:scale-[0.98]',
            )}
            style={{
              backgroundColor: customColors?.primary || '#22c55e',
              borderColor: customColors?.secondary || customColors?.primary || '#4ade80',
              boxShadow: customColors?.secondary
                ? `0 0 10px ${customColors.primary}60, 0 0 20px ${customColors.secondary}50, inset 0 0 20px ${customColors.secondary}20`
                : customColors
                  ? `0 0 10px ${customColors.primary}60, inset 0 0 20px ${customColors.primary}20`
                  : '0 0 10px rgba(34,197,94,0.4), inset 0 0 20px rgba(74,222,128,0.15)',
              color: 'var(--custom-text-color)'
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = customColors
                ? `0 0 20px ${customColors.primary}CC, 0 0 30px ${customColors.secondary || customColors.primary}60, inset 0 0 30px ${customColors.secondary || customColors.primary}30`
                : '0 0 20px rgba(34,197,94,0.8), 0 0 30px rgba(74,222,128,0.4), inset 0 0 30px rgba(74,222,128,0.2)'
              e.currentTarget.style.borderColor = customColors?.secondary || customColors?.primary || '#4ade80'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = customColors
                ? `0 0 10px ${customColors.primary}60, inset 0 0 20px ${customColors.secondary || customColors.primary}20`
                : '0 0 10px rgba(34,197,94,0.4), inset 0 0 20px rgba(74,222,128,0.15)'
            ...
            disabled={isEditing}
          >
            {/* Terminal text background glow */}
            {customColors?.secondary && (
              <div
                className="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity"
                style={{
                  background: `linear-gradient(90deg, transparent, ${customColors.secondary}60 50%, transparent)`
                }}
              />
            )}
            ...
            <div
              ...
              style={{
                backgroundColor: customColors?.secondary || customColors?.primary || '#22c55e',
                boxShadow: customColors?.secondary
                  ? `0 0 10px ${customColors.secondary}`
                  : `0 0 10px ${customColors?.primary || '#22c55e'}`
              }}
            />
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            <div
              className="absolute inset-0 border-4 rounded-lg z-0"
              style={{
            ...
            <div
              className="absolute inset-[6px] border-2 rounded-md opacity-70 z-0"
              style={{
            ...
            {/* Corner ornaments */}
            <div className="absolute -top-2 -left-2 w-4 h-4 transform rotate-45 z-0"
              style={{ backgroundColor: customColors?.accent || '#fbbf24' }}
            />
            <div className="absolute -top-2 -right-2 w-4 h-4 transform rotate-45 z-0"
              style={{ backgroundColor: customColors?.accent || '#fbbf24' }}
            />
            <div className="absolute -bottom-2 -left-2 w-4 h-4 transform rotate-45 z-0"
              style={{ backgroundColor: customColors?.accent || '#fbbf24' }}
            />
            <div className="absolute -bottom-2 -right-2 w-4 h-4 transform rotate-45 z-0"
              style={{ backgroundColor: customColors?.accent || '#fbbf24' }}
            />
            ...
            {renderIconAndText('font-bold text-sm sm:text-base tracking-wider relative z-10', 'w-6 h-6 sm:w-7 sm:h-7')}
          </button>
        </LinkWrapper>
      )
    }
        ...
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            <div className="z-10 flex items-center justify-between h-full">
              <div
                className="flex items-center flex-1 h-full relative"
                style={{
                  color: 'var(--custom-text-color)'
                }}
              >
                {renderIconAndText('font-semibold text-sm tracking-wide', 'w-5 h-5')}
              </div>

              {/* Arrow indicator */}
              <svg
                className="w-4 h-4 transform group-hover:translate-x-1 transition-transform duration-200 flex-shrink-0"
                fill="none"
                viewBox="0 0 24 24"
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('font-bold text-base tracking-wide', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            {/* Content */}
            <div
              className="z-10 h-full flex items-center opacity-90 group-hover:opacity-100"
              style={{
                color: 'var(--custom-text-color)',
            ...
            >
              {renderIconAndText('font-serif text-base tracking-wider', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            {/* Neon border glow with dual colors */}
            <div
              className="absolute inset-0 border-2"
              style={{
                borderColor: customColors?.secondary || '#fbbf24',
                boxShadow: customColors?.secondary
                  ? `0 0 20px ${customColors.primary}90, 0 0 35px ${customColors.secondary}70, inset 0 0 20px ${customColors.secondary}30`
                  : customColors
                    ? `0 0 20px ${customColors.primary}90, inset 0 0 20px ${customColors.primary}20`
                    : '0 0 20px rgba(236,72,153,0.9), inset 0 0 20px rgba(236,72,153,0.2)'
              }}
            />

            {/* CRT Scanlines with secondary color tint */}
            <div
              className="absolute inset-0 pointer-events-none opacity-20"
              style={{
                backgroundImage: customColors?.secondary
                  ? `repeating-linear-gradient(0deg, transparent, transparent 2px, ${customColors.secondary}20 2px, ${customColors.secondary}20 4px)`
                  : 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,0,0,0.3) 2px, rgba(0,0,0,0.3) 4px)',
                animation: 'scanline 8s linear infinite'
              }}
            />

            {/* Neon glow corners with secondary color */}
            <div
              className="absolute top-0 left-0 w-2 h-2"
              style={{
                backgroundColor: customColors?.secondary || '#fbbf24',
                boxShadow: `0 0 10px ${customColors?.secondary || '#fbbf24'}, 0 0 20px ${customColors?.secondary || '#fbbf24'}80`
              }}
            />
            <div
            ...
            {/* Hover glow pulse with gradient */}
            <div
              className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              style={{
                background: customColors?.secondary
                  ? `radial-gradient(circle at center, ${customColors.primary}40, ${customColors.secondary}20, transparent 70%)`
                  : customColors
                    ? `radial-gradient(circle at center, ${customColors.primary}30, transparent 70%)`
            ...
            >
              {renderIconAndText('text-sm font-black tracking-widest', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
        ...
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            <div className="z-10 flex items-center justify-between h-full">
              ...
              >
                {renderIconAndText('text-sm font-black tracking-wider italic', 'w-6 h-6 sm:w-7 sm:h-7')}
              </div>

              {/* Speed indicator chevrons */}
              <div className="flex gap-0.5 transform group-hover:translate-x-2 transition-transform duration-200 flex-shrink-0">
    ...
    if (validatedStyle === 'horror-glitch') {
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            {/* Dark background with subtle primary tint */}
            <div
              className="absolute inset-0 border"
              style={{
                backgroundColor: customColors?.primary || '#7f1d1d',
                borderColor: customColors?.secondary || customColors?.primary || '#991b1b',
                boxShadow: customColors?.secondary
                  ? `inset 0 0 30px ${customColors.secondary}40, 0 0 15px ${customColors.primary}60`
                  : `inset 0 0 30px rgba(127,29,29,0.3), 0 0 15px ${customColors?.primary || '#7f1d1d'}60`
              }}
            />

            {/* Corrupted overlay with secondary color tint */}
            <div
              ...
              style={{
                ...
                backgroundColor: customColors?.secondary ? `${customColors.secondary}10` : undefined
              }}
            />

            {/* Glitch stripes with secondary color */}
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-100">
              <div
                className="absolute left-0 right-0 h-0.5"
                style={{
                  top: '20%',
                  backgroundColor: customColors?.secondary || '#ef4444',
                  boxShadow: `0 0 5px ${customColors?.secondary || '#ef4444'}, 0 0 10px ${customColors?.secondary || '#ef4444'}80`,
              ...
              <div
                ...
                style={{
                  top: '60%',
                  backgroundColor: customColors?.secondary || '#dc2626',
                  boxShadow: `0 0 5px ${customColors?.secondary || '#dc2626'}, 0 0 10px ${customColors?.secondary || '#dc2626'}80`,
                  animation: 'glitchStripe 0.4s infinite reverse'
                }}
              />
            </div>

            {/* RGB split effect on hover with primary and secondary */}
            <div
            ...
            >
              {renderIconAndText('text-sm font-normal tracking-wide', 'w-5 h-5 sm:w-6 sm:h-6')}
            </div>

            {/* Blood drip effect (corner accents) with secondary color */}
            <div
              className="absolute top-0 left-4 w-1 h-4 opacity-50 group-hover:h-8 transition-all duration-300"
              style={{
                backgroundColor: customColors?.secondary || '#991b1b',
                filter: 'blur(1px)',
                boxShadow: customColors?.secondary ? `0 0 5px ${customColors.secondary}` : undefined
              }}
            />
            <div
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base font-black tracking-wider italic transform group-hover:scale-105 transition-transform duration-200', 'w-6 h-6 sm:w-8 sm:h-8')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base font-bold tracking-wide', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-sm font-bold tracking-wider', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            {/* Content */}
            <div className="z-10 flex items-center justify-center gap-3 h-full">
              <div
                className="w-1 h-6"
                style={{
              ...
              >
                {renderIconAndText('text-xs tracking-widest', 'w-5 h-5 sm:w-6 sm:h-6')}
              </div>
            </div>
          </button>
        </LinkWrapper>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-sm font-bold tracking-wide', 'w-6 h-6 sm:w-8 sm:h-8')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-sm font-bold tracking-wide', 'w-5 h-5 sm:w-6 sm:h-6')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base font-black tracking-widest italic', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-sm sm:text-base font-bold tracking-wide', 'w-5 h-5 sm:w-6 sm:h-6')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base sm:text-lg font-semibold tracking-wide', 'w-5 h-5 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-sm sm:text-base font-serif italic tracking-wide', 'w-5 h-5 sm:w-6 sm:h-6')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base sm:text-lg font-black tracking-wider italic', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base font-medium tracking-wide', 'w-5 h-5 sm:w-6 sm:h-6')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base sm:text-lg font-bold italic tracking-wide', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            {/* Content */}
            <div
              className="relative z-10 h-full flex items-center pt-2"
              style={{
                color: 'var(--custom-text-color)',
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-sm sm:text-base font-black tracking-wide', 'w-5 h-5 sm:w-6 sm:h-6')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base font-medium tracking-wide', 'w-5 h-5 sm:w-5 sm:h-5')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-base sm:text-lg font-black tracking-wide italic', 'w-6 h-6 sm:w-7 sm:h-7')}
            </div>
      ...
      return (
        <LinkWrapper key={item.id || index} item={item}>
          ...
          >
            ...
            >
              {renderIconAndText('text-lg sm:text-xl font-black tracking-widest', 'w-7 h-7 sm:w-8 sm:h-8')}
            </div>
    ...
    <div className={cn('space-y-6 p-4', className)}>
      ...
      <div>
        ...
        <div className="flex gap-2 flex-wrap">
          {(['pill', 'neon', 'pixel', 'hologram', 'bubble', 'cyberpunk', 'metallic', 'terminal'] as const).map((style) => (
            <Button
              key={style}
