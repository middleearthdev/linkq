    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleEmailSignUp} className="space-y-6">
        ...
        <div className="flex items-start space-x-3">
          ...
          <label htmlFor="terms" className="text-sm text-gray-600 leading-relaxed">
            I agree to the{" "}
            <Button variant="link" className="text-sm p-0 h-auto" style={{ color: '#66A38A' }}>
              Terms of Service
            </Button>{" "}
            and{" "}
            <Button variant="link" className="text-sm p-0 h-auto" style={{ color: '#66A38A' }}>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 text-gray-500" style={{ backgroundColor: '#F7F9FA' }}>Or register with</span>
        </div>
      </div>
      ...
      <Button 
        ...
        disabled={loading}
        variant="outline"
        className="w-full h-14 rounded-2xl text-gray-700 hover:text-gray-900"
        style={{ 
          backgroundColor: '#EFF2F5',
          borderColor: '#DFE5EB'
        }}
